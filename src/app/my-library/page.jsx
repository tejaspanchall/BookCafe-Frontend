...
export default function MyLibrary() {
  ...
  const getImageUrl = (imagePath) => {
    console.log('MyLibrary - Constructing image URL:', {
    ...
    if (!imagePath) {
      console.log('MyLibrary - No image path provided, using placeholder');
      return "https://via.placeholder.com/200x300?text=Book+Cover";
    }

    // If it's already a full URL (starts with http:// or https://)
    if (imagePath.startsWith('http://') || imagePath.startsWith('https://')) {
      console.log('MyLibrary - Using direct URL:', imagePath);
      return imagePath;
    }
    ...
    console.log('MyLibrary - Constructed storage URL:', {
      baseUrl,
      imagePath,
      imageName,
      finalUrl
